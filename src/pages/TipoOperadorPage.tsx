...
export function TipoOperadorPage() {
  ...
  // Filtered data
  const filteredTiposOperador = (Array.isArray(tiposOperador) && tiposOperador.length > 0) ? tiposOperador.filter(tipo =>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-blue-200/40">
              {filteredTiposOperador.length === 0 ? (
                <tr>
                ...
                filteredTiposOperador.map((tipo) => (
                  <tr key={tipo.cd_tipo_operador} className="hover:bg-blue-50/30 border-b border-blue-200/20">
